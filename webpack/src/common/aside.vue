<template>
  <div>
    <el-menu
      ...
      <el-menu-item index="timetable" :class="{active: $route.name === '课堂汇报表'}">
        <i class="el-icon-s-grid"></i> &#12288课堂汇报表
      </el-menu-item>
      ...
      <el-menu-item index="course" v-if="level === 0" :class="{active: $route.name === '课堂汇报录入'}">
        <i class="el-icon-s-promotion"></i>
        <span slot="title">&#12288课堂汇报录入</span>
      </el-menu-item>
